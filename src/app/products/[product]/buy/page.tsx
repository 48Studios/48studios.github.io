...
const products: Record<string, Product> = {
    'smart-sensor': {
        ...
        image: 'https://images.unsplash.com/photo-1611078489935-0cb964de46d6?ixlib=rb-1.2.1&auto=format&fit=crop&w=1074&q=80',
        category: 'iot',
        price: 89.99,
        available: true
    },
    'plant-monitor': {
        ...
        image: 'https://images.unsplash.com/photo-1558383409-ab7ef8db3e01?ixlib=rb-1.2.1&auto=format&fit=crop&w=1074&q=80',
        category: 'iot',
        price: 49.99,
        available: true
    },
    'motion-sensor': {
        ...
        image: 'https://images.unsplash.com/photo-1558002038-1055907df827?ixlib=rb-1.2.1&auto=format&fit=crop&w=1074&q=80',
        category: 'iot',
        price: 39.99,
        available: true
    },
    'environment-tracker': {
        ...
        image: 'https://images.unsplash.com/photo-1580983218765-f663bec07b37?ixlib=rb-1.2.1&auto=format&fit=crop&w=1074&q=80',
        category: 'iot',
        price: 119.99,
        available: true
    },
    'water-quality': {
        ...
        image: 'https://images.unsplash.com/photo-1576400883215-7083980b6193?ixlib=rb-1.2.1&auto=format&fit=crop&w=1074&q=80',
        category: 'iot',
        price: 69.99,
        available: true
    }
            ...
            <main className="flex-1 pt-20">
                ...
                <div className="container mx-auto px-4 py-4 text-sm">
                    <nav className="flex">
                        ...
                        <span className="mx-2 text-muted-foreground">/</span>
                        <Link href={`/products/${product.id}`} className="text-muted-foreground hover:text-foreground">{product.name}</Link>
                        <span className="mx-2 text-muted-foreground">/</span>
                ...
                <div className="container mx-auto px-4 py-8 max-w-6xl">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <Label htmlFor="quantity" className="min-w-20">Quantity:</Label>
                                        <div className="flex">
                                            <Button
                                                variant="outline"
                                                size="sm"
                                    ...
                                    <div className="pt-4">
                                        <h3 className="text-md font-medium mb-3">Shipping Options</h3>
                        ...
                        <div>
                            <div className="border border-border/50 rounded-lg p-6 bg-card/50 sticky top-24">
                                ...
                                <Button
                                    ...
                                    className="w-full bg-coral hover:bg-coral-dark text-white mb-4"
                                    size="lg"
                                >
                                    Complete Purchase
                                </Button>
                                ...
                                <div className="mt-6 space-y-3">
                                    <div className="flex items-start gap-2">
                                        <TruckIcon className="h-4 w-4 text-coral mt-1" />
                                        <p className="text-xs">
                                            <span className="font-medium">Free shipping</span> on orders over $100.
                                        </p>
                                    </div>
                                    <div className="flex items-start gap-2">
                                        <Package className="h-4 w-4 text-coral mt-1" />
                                        <p className="text-xs">
